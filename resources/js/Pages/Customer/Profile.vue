        ...
        <div class="col-lg-3">
            <div class="card position-sticky top-1">
                <ul class="nav flex-column bg-white border-radius-lg p-3">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll @click.prevent="UserTransactions(customer.id)">
                            <div class="icon me-2">
                                <svg class="text-dark mb-1" width="16px" height="16px" viewbox="0 0 42 42"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll @click.prevent="UserLoans(customer.id)">
                            <div class="icon me-2">
                                <svg class="text-dark mb-1" width="16px" height="16px" viewbox="0 0 42 42"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <li class="nav-item pt-2">
                        <a class="nav-link text-body" data-scroll @click.prevent="UserSavings(customer.id)">
                            <div class="icon me-2">
                                <svg class="text-dark mb-1" width="16px" height="16px" viewbox="0 0 42 42"
                                    version="1.1" xmlns="http://www.w3.org/2000/svg"
                                    xmlns:xlink="http://www.w3.org/1999/xlink">
        ...
        <div class="col-lg-9 mt-lg-0 mt-4">
            ...
            <div class="card mt-4" id="basic-info">
                ...
                <div class="card-body pt-0">
                    <form @submit.prevent="updateUser(customer.id)">
                        <div class="row">
                            <div class="col-6">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input v-model="form.phone" :class="errors.phone ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Thompson" required="required">
                                </div>
                                <span v-if="errors.phone" class="text text-sm text-danger">{{ errors.phone }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <select v-model="form.gender" :class="errors.gender ? 'border border-danger' : ''" class="form-control" >
                                        <option value="">Select Gender</option>
                                        <option value="male">Male</option>
                                        <option value="female">Female</option>
                                    </select>
                                </div>
                                <span v-if="errors.gender" class="text text-sm text-danger">{{ errors.gender }}</span>
                            </div>
                            <div class="col-6">
                                <label class="form-label">BVN</label>
                                <div class="input-group">
                                    <input v-model="form.bvn" :class="errors.bvn ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Thompson" required="required" disabled>
                                </div>
                                <span v-if="errors.bvn" class="text text-sm text-danger">{{ errors.bvn }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input v-model="form.city" :class="errors.city ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Alec" required="required" disabled>
                                </div>
                                <span v-if="errors.city" class="text text-sm text-danger">{{ errors.city }}</span>
                            </div>
                            <div class="col-6">
                                <label class="form-label">Company location</label>
                                <div class="input-group">
                                    <input v-model="form.company_location" :class="errors.company_location ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Thompson" required="required" disabled>
                                </div>
                                <span v-if="errors.company_location" class="text text-sm text-danger">{{ errors.company_location }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <input v-model="form.company_name" :class="errors.company_name ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Alec" required="required" disabled>
                                </div>
                                <span v-if="errors.company_name" class="text text-sm text-danger">{{ errors.company_name }}</span>
                            </div>
                            <div class="col-6">
                                <label class="form-label">Employee Status</label>
                                <div class="input-group">
                                    <!-- <input v-model="form.employee_status" :class="errors.employee_status ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Thompson" required="required"> -->
                                    <select v-model="form.employee_status" :class="errors.employee_status ? 'border border-danger' : ''" class="form-control" >
                                ...
                                <span v-if="errors.employee_status" class="text text-sm text-danger">{{ errors.employee_status }}</span>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-6">
                                ...
                                <div class="input-group">
                                    <select v-model="form.marital_status" class="form-select" :class="errors.marital_status ? 'border border-danger' : ''" >
                                ...
                                <span v-if="errors.marital_status" class="text text-sm text-danger">{{ errors.marital_status }}</span>
                            </div>
                            <div class="col-6">
                                <label class="form-label">Residential Address</label>
                                <div class="input-group">
                                    <input v-model="form.address" :class="errors.address ? 'border border-danger' : ''" class="form-control" type="text"
                                        placeholder="Thompson" required="required" disabled>
                                </div>
                                <span v-if="errors.address" class="text text-sm text-danger">{{ errors.address }}</span>
                            </div>
                        </div>
            ...
            <div class="card mt-4" id="password">
                <form @submit.prevent="updateUserPassword(customer.id)">
                <div class="card-header">
            ...
            <div class="card mt-4" id="delete">
                ...
                <div class="card-body d-sm-flex pt-0">
                    <div class="d-flex align-items-center mb-sm-0 mb-4">
                        <div>
                            <div class="form-check form-switch mb-0">
                                <input v-model="confirmDelete" class="form-check-input" type="checkbox" id="flexSwitchCheckDefault0">
                            </div>
                        </div>
                        <div class="ms-2" v-if="confirmDeleteText">
                            <span class="text-dark font-weight-bold d-block text-sm text-danger">Please Confirm</span>
                            <span class="text-xs d-block text-danger">{{ confirmDeleteText }}</span>
                        </div>
                    ...
                    <button @click.prevent="deleteUser" class="btn bg-gradient-danger mb-0 ms-auto" type="button" name="button">Delete
                        Account</button>
                </div>
            </div>
        </div>
...
import { computed, ref } from "vue";
    ...
    const form = useForm({
        ...
        phone: props.customer.telephone,
        gender: props.customer.gender,
        bvn: props.customer.bvn,
        city: props.customer.city,
        company_location: props.customer.company_location,
        company_name: props.customer.company_name,
        employee_status: props.customer.employment_status,
    ...
    const updateUser = (id) => {
        router.put(`/customer/update/${id}`,form,{ preserveScroll: true });
    }
    ...
    const updateUserPassword = (id) => {
        router.put(`/customer/update/password/${id}`,password_form,{ preserveScroll: true });
    }
